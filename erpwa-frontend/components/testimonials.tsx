    ...
    <section id="testimonials" className="mb-24 py-24 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl relative z-10 px-6">
        <div className="mx-auto max-w-[540px]">
          ...
          <h2 className="from-foreground/60 via-foreground to-foreground/60 dark:from-muted-foreground/55 dark:via-foreground dark:to-muted-foreground/55 mt-5 bg-linear-to-r bg-clip-text text-center text-4xl font-semibold tracking-tighter text-transparent md:text-[54px] md:leading-[60px] relative z-10">
            What our users say
          </h2>

          <p className="mt-5 relative z-10 text-center text-lg text-slate-400">
            From intuitive design to powerful features, our app has become an
            essential tool for businesses around the world.
          </p>
        </div>

        <div className="my-16 flex max-h-[738px] justify-center gap-6 overflow-hidden mask-[linear-gradient(to_bottom,transparent,black_25%,black_75%,transparent)]">
          <div>
        ...
        <div className="-mt-8 flex justify-center">
          <button className="group relative inline-flex items-center gap-2 rounded-full border border-[#e78a53]/30 bg-black/50 px-6 py-3 text-sm font-medium text-white transition-all hover:border-[#e78a53]/60 hover:bg-[#e78a53]/10 active:scale-95 cursor-pointer">
            <div className="absolute inset-x-0 -top-px mx-auto h-px w-3/4 bg-linear-to-r from-transparent via-[#e78a53]/40 to-transparent"></div>
            <div className="absolute inset-x-0 -bottom-px mx-auto h-px w-3/4 bg-linear-to-r from-transparent via-[#e78a53]/40 to-transparent"></div>
            <svg
