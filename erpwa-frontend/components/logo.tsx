  ...
  <defs>
    <style>
      {`
              ...
              html.dark .navy, .force-dark .navy {
                fill: #eae2e2ff;
              }
              ...
              html.dark .logo-stroke, .force-dark .logo-stroke {
                stroke: #000000;
              }
              ...
              /* Dark mode override */
              html.dark .text-erp, .force-dark .text-erp {
                fill: #e0d1d1ff;
              }
      ...
      >
        ...
        <g transform="translate(130, 120)">
          {isSidebar ? (
            ...
            <>
              <text x="5" y="0" className="orange text-ps">
                PS
              </text>
              <text x="190" y="0" className="text-erp text-erp-sidebar">
                erp
              </text>
            </>
          ) : (
            ...
            <>
              ...
              <text x="5" y="90" className="text-erp">
                erp
              </text>
            </>
          )}
