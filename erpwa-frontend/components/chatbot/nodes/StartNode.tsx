        ...
        {isEditing ? (
          <div className="space-y-3 nodrag">
            <div className="space-y-1">
              ...
              <input
                type="text"
                className="w-full text-xs font-bold border-none bg-gray-50 p-2 rounded-md focus:ring-1 focus:ring-purple-500 outline-none"
                value={localData.triggerKeyword}
                onChange={(e) =>
                  setLocalData({ ...localData, triggerKeyword: e.target.value })
                }
          ...
          >
            <div className="text-[11px] font-bold text-gray-800 mb-1 flex items-center gap-1 group-hover:text-purple-600 transition-colors">
